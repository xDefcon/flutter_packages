...
void main() {
  group('diffs', () {
    ...
    test('handle mapColorScheme', () async {
      const diff = MapConfiguration(mapColorScheme: MapColorScheme.dark);
      ...
      expect(diff.diffFrom(empty), diff);
      // A diff applied to non-empty options should update that field.
      expect(updated.mapColorScheme, MapColorScheme.dark);
      // The hash code should change.
      expect(empty.hashCode, isNot(diff.hashCode));
    });
  });
  ...
  group('isEmpty', () {
    ...
    test('is false with mapColorScheme', () async {
      const diff = MapConfiguration(mapColorScheme: MapColorScheme.light);
